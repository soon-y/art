          ...
          <div>
            <div>
              {data !== null ?
                ...
                <div className="md:hidden animate-pulse bg-gray-100 w-36 h-5 rounded-lg"></div>
              }
            ...
            <div>
              <div className="hidden md:block bg-gray-100 w-full h-[420px] mx-auto my-1 shadow-xl my-10 p-6 rounded-xl">
                <div className='border-b'>
                  <div className="bg-gray-200 w-48 h-4 animate-pulse rounded-md my-1"></div>
                  <div className="bg-gray-200 w-full h-7 animate-pulse rounded-md mt-2"></div>
              ...
              <div className='md:hidden fixed border-t bottom-0 left-0 bg-gray-100 w-full h-[80px] grid grid-cols-[1fr_170px] items-center px-6 gap-4 z-100'>
                ...
                <div className='flex'>
                  <div className='bg-gray-200 w-[80px] h-10 rounded-lg animate-pulse' ></div>
                  <div className='bg-gray-200 w-[80px] h-10 ml-[10px] rounded-lg animate-pulse' ></div>
                </div>
              </div>
            </div>
          }
